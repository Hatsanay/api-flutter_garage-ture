...
$sql = "SELECT COUNT(repairreqid) AS countnoti FROM repairreq WHERE repairreqgarageid = $garageid AND repairreqstatus < 5 ORDER BY repairreqid";
// SELECT,COUNT(repairreqid) AS amountnoti FROM repairreq WHERE repairreqgarageid = $garageid AND repairreqstatus < 5 ORDER BY repairreqid
